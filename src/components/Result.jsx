...
function Result({ score, onRestart }) {
  return (
    <div className="bg-orange-600 p-8 rounded shadow-md w-full max-w-lg text-center flex flex-col gap-4 ">
      <h2
        className={`text-2xl font-bold  ${
          score >= 9 ? "text-green-600" : "text-red-900"
        }`}
      >
        {score >= 9
          ? "Tebrikler! Başarılı oldunuz ve robotun parçalarını tamamladınız! "
          : "Maalesef olmadı, tekrar deneyiniz."}
      </h2>
